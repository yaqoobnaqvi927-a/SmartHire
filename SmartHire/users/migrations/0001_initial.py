    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_type', models.CharField(choices=[('student', 'Student'), ('recruiter', 'Recruiter')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extracted_skills_json', models.JSONField(blank=True, default=list)),
                ('degree_extracted', models.CharField(blank=True, max_length=255)),
                ('cv_file_path', models.FileField(blank=True, null=True, upload_to='candidate_cvs/')),
