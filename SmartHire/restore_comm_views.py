...
content = """from rest_framework import viewsets, permissions, status
...
with open(r"e:\FYP\SmartHire\communications\views.py", "w", encoding="utf-8") as f:
    f.write(content)
    print("Updated communications/views.py")
